...
/datum/world_topic/asay/Run(list/input)
	var/msg = "<font color='#FF4500'><span class='adminobserver'><span class='prefix'>DISCORD ADMIN:</span> <EM>[input["admin"]]</EM>: <span class='message'>[input["asay"]]</span></span></font>"

/client/proc/dsay(msg as text)
	...
	var/rendered = "<span class='game deadsay'><span class='prefix'>œ–»«–¿ :</span> <span class='name'>[rank_name]([admin_name])</span> „Ó‚ÓËÚ, <span class='message'>\"[emoji_parse(msg)]\"</span></span>"

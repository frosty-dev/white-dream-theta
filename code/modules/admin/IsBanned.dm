		...
		if(!SSdbcore.Connect())
			...
			for(var/i in ban_details)
				...
				if(i["expiration_time"])
					expires = "���������� �� [DisplayTimeText(text2num(i["duration"]) MINUTES)] ������������� � [i["expiration_time"]]."
				var/desc = {"������ ��������, ([i["key"]]). �����: [ph2up(i["reason"])]. ���������� #[i["id"]]) ������ [i["admin_key"]] � [i["bantime"]] �� ����� ������ [i["round_id"]]. [expires]"}

/datum/admins/proc/player_panel_new()//The new one
	...
	var/dat = "<html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8' /><meta http-equiv='X-UA-Compatible' content='IE=edge'/><title>Player Panel</title></head>"

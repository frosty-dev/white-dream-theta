...
/obj/item/dice/proc/diceroll(mob/user)
	...
	if(user != null) //Dice was rolled in someone's hand
		user.visible_message("[user] ������ [src]. �� ������������ �� [result]. [comment]", \
							 "<span class='notice'>�� �������� [src]. �� ������������ �� [result]. [comment]</span>", \
							 "<span class='italics'>�� ������� ��� ������� [src], ��� ������ ��� [fake_result].</span>")
	else if(!src.throwing) //Dice was thrown and is coming to rest
		visible_message("<span class='notice'>[src] ��������������� ������������� �� [result]. [comment]</span>")

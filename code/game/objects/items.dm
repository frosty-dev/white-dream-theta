...
/obj/item/examine(mob/user) //This might be spammy. Remove?
	...
	research_msg += ".<br><font color='purple'>���������:</font> "
	if (materials.len)
		sep = ""
...
/obj/item/proc/hit_reaction(mob/living/carbon/human/owner, atom/movable/hitby, attack_text = "����", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
	SEND_SIGNAL(src, COMSIG_ITEM_HIT_REACT, args)
	if(prob(final_block_chance))
		owner.visible_message("<span class='danger'>[owner] ��������� [attack_text] ��� ������ [src]!</span>")
		return 1
	return 0
...
/obj/item/proc/eyestab(mob/living/carbon/M, mob/living/carbon/user)
	...
	if(M.is_eyes_covered())
		...
		to_chat(user, "<span class='warning'>��� ����� ������ ������ � [M.ru_ego()] ����, ����� ������� ���!</span>")
		return
	...
	if(M != user)
		M.visible_message("<span class='danger'>[user] ��������� ���� [M] ��������� [src]!</span>", \
							"<span class='userdanger'>[user] ��������� ��� ���� ��������� [src]!</span>")
	else
		user.visible_message( \
			"<span class='danger'>[user] ��������� ���� ���� ��� ������ [src]!</span>", \
			"<span class='userdanger'>�� ��������� ���� ���� ��� ������ [src]!</span>" \
		)
	if(is_human_victim)
	...
	log_combat(user, M, "�������", "[src.name]", "(INTENT: [uppertext(user.a_intent)])")

...
/datum/game_mode/overthrow
	...
	restricted_jobs = list("Russian Officer", "International Officer", "Warden", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer")
